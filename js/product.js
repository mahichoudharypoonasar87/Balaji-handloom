...
function renderGallery(images) {
  ...
  // Remove any previous "no image" placeholder before re-rendering
  mainImgWrap.querySelector(".no-image-placeholder")?.remove();

  if (!images.length) {
    mainImg.style.display = "none";
    mainImg.removeAttribute("src");
    mainImgWrap.insertAdjacentHTML("beforeend", productImageHtml("", currentProduct?.name || "Product", "product-main-img"));
