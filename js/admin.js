    ...
    if (!profile?.isAdmin) {
      document.body.innerHTML = `
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100svh;font-family:system-ui;text-align:center;padding:2rem;">
          ...
          <a href="index.html" style="padding:0.75rem 2rem;background:#8B1A1A;color:#fff;border-radius:9999px;text-decoration:none;font-weight:600;">Go to Store</a>
        </div>
      `;
      return;
    }
...
function renderProductsTable(products) {
  ...
  container.innerHTML = products
    ...
    <tr>
      <td>
        <img src="${p.images?.[0] || "assets/images/placeholder.webp"}" alt="${p.name}" class="admin-table__img" loading="lazy" />
      </td>
      <td>
